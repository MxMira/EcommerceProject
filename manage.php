        ...
        <div class="row show-grid">
            <form name="signupform" id="signupform" method="post" action="adduser.php" class="form-signin"
                ...
                <div class="col-md-3">
                    ...
                    <input required type="text" maxlength="45" id="inputFirstName" name="inputFirstName" value="<?php echo $fname ?>"
    ...
    <span class="req">
        ...
        ?>
                ...
                <div class="col-md-3">
                    ...
                    <input required type="text" maxlength="45" id="inputLastName" name="inputLastName" value="<?php echo $lname ?>"
                           class="form-control"
    ...
    <span class="req">
         ...
         ?>
                ...
                <div class="col-md-3">
                    ...
                    <input required type="email" maxlength="45" id="inputEmail" name="inputEmail" value="<?php echo $email ?>"
                           class="form-control"
    ...
    <span class="req">
        ...
        ?>
                ...
                <div class="col-md-3">
                    ...
                    <input required maxlength="11" minlength="11" data-parsley-type="digits" type="text" id="inputMobile" name="inputMobile" value="<?php echo $mobile ?>"
                           class="form-control"
